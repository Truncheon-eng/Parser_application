...
def main():
    """
    Данная ф-ия вызывается, тогда, когда на сервер приходит POST запрос по ссылке: http://localhost:5000,
    с целью получения данных, отсортированных по определённому значению. Внутри этой ф-ии вызывается другая ф-ия под
